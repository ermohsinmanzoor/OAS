...
<html>
    ...
    <body style="background-image:url('./images/inbg.jpg');">
        ...
        <div id="ddown">
            ...
            <img src="images/images.jpeg" style="height:470px;width:550px;border-top-left-radius:15px;border-bottom-left-radius:15px;" ></img>
            </div>
             <div id="drig">
                 <br>
            <font style="color:black; margin-left:30px; font-size:22px; font-family: verdana;font-weight: bold;">Sign Up Here</font>
                ...
                <tr>
                    <td>
                        <font style="color:black; margin-left:30px; font-family: Verdana;  margin-top:15px; font-size:17px;">Password * </font>
                ...
                <tr>
                    <td  style="padding-bottom: 1em;">
                        ...
                        <input type='password' id='in_pass' name='in_pass' VT="PAS" required="true"> 
                    </td>
