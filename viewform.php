...
<html>
  ...
  <div class="container">
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><img src="./images/Logo-T.jpg" width="73%"> </td>
        ...
        ?>
             ...
             <center> <input type="submit" id="print" class="toggle btn btn-primary" value="Print" onClick="printpage();"></center>                             </form>
            </body>
</html>
